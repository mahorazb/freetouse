...
var zombieGroup = mp.game.ped.addRelationshipGroup("ZOMBIE");
var animalGroup = mp.game.ped.addRelationshipGroup("ANIMAL");
var adminGroup = mp.game.ped.addRelationshipGroup("ADMIN");

//mp.game.ped.setRelationshipBetweenGroups(1, mp.game.joaat('zombeez'), mp.game.joaat('ADMIN'));
//mp.game.ped.setRelationshipBetweenGroups(1, mp.game.joaat('PLAYER'), mp.game.joaat('ADMIN'));
//mp.game.ped.setRelationshipBetweenGroups(1, mp.game.joaat('ADMIN'), mp.game.joaat('PLAYER'));
//mp.game.ped.setRelationshipBetweenGroups(1, mp.game.joaat('ADMIN'), mp.game.joaat('zombeez'));
mp.game.ped.setRelationshipBetweenGroups(1, mp.game.joaat('ZOMBIE'), mp.game.joaat('PLAYER'));
mp.game.ped.setRelationshipBetweenGroups(5, mp.game.joaat('ZOMBIE'), mp.game.joaat('bandit'));
mp.game.ped.setRelationshipBetweenGroups(5, mp.game.joaat('PLAYER'), mp.game.joaat('ZOMBIE'));


//mp.game.ped.setRelationshipBetweenGroups(5, mp.game.joaat('zombeez'), mp.game.joaat('zombeez'));

const localPlayer = mp.players.local;

//localPlayer.setRelationshipGroupHash(adminGroup);
    ...
    constructor(){
        ...
        class Ped {
            constructor({id: _id, entity: _entity}){
                ...
                this.controllerStreamInDist = 300;
                this.controllerStreamOutDist = 320;
            ...
            async onStreamIn(){
                if(this.entity.isDynamic){
                    ...
                    if(this.staticDead) {
                        ...
                        this.entity.setMaxHealth(200),
                        this.entity.setHealth(200);
                    }
            ...
            onDeath() {
                ...
                mp.events.callRemote("server:peds:died", this.id, cords.x, cords.y, cords.z);
            }
            isOnStream() {
            ...
            requireControllerStatus() {
                mp.events.callRemote("server:peds:require_controller", this.id);
            }
            removeControllerStatus() {
                mp.events.callRemote("server:peds:remove_controller", this.id);
            }
...
global.ServerPed.registerControllerScript("ANIMAL", {
    onStreamIn(a) {},
    onStreamOut(a) {},
    onChangeController(a, b) {
      if (localPlayer === b) {
      a.entity.setMaxHealth(200),
        a.entity.setHealth(200),
...
global.ServerPed.registerControllerScript("ZOMBIE", {
    onStreamIn(a) {},
    onStreamOut(a) {},
    onChangeController(a, b) {
      if (localPlayer === b) {
        mp.game.invoke("0xF25DF915FA38C5F3", a.entity.handle, false);
        if(a.entity.getVariable("meleeWeapon"))
        {
            mp.game.invoke("0x14E56BC5B5DB6A19", a.entity.handle, mp.game.joaat(a.entity.getVariable("meleeWeapon")) << 0, 1),
            mp.game.invoke("0xBF0FD6E56C964FCB", a.entity.handle, mp.game.joaat(a.entity.getVariable("meleeWeapon")) << 0, 1, false, true),
            mp.game.invoke("0x0725A4CCFDED9A70", a.entity.handle, true, true, true, true);
        }
        else if(a.entity.getVariable("weapon"))
        {
            mp.game.invoke("0x14E56BC5B5DB6A19", a.entity.handle, mp.game.joaat(a.entity.getVariable("weapon")) << 0, 0),
            mp.game.invoke("0xBF0FD6E56C964FCB", a.entity.handle, mp.game.joaat(a.entity.getVariable("weapon")) << 0, 30, false, true),
            mp.game.invoke("0x0725A4CCFDED9A70", a.entity.handle, true, true, true, true);
        }
        mp.game.invoke("0x3C028C636A414ED9", a.entity.handle, true),
        mp.game.invoke("0x7A6535691B477C48", a.entity.handle, 3),
        a.entity.setRelationshipGroupHash(mp.game.joaat('ZOMBIE')),
        a.entity.setMaxHealth(200),
        a.entity.setHealth(200),
        a.entity.setSeeingRange(30.0),
        a.entity.setHearingRange(100.0),
        a.entity.setCanBeDamaged(!0),
          a.entity.setCanRagdoll(!1),
          a.entity.setCanRagdollFromPlayerImpact(!1),
        //  a.entity.setCanBeDraggedOut(false),
          a.entity.setProofs(!1, !0, !0, !0, !1, !0, !0, !0),
          a.entity.setSuffersCriticalHits(!1);
        const b = a.entity.getCoords(!0), c = mp.game.gameplay.getGroundZFor3dCoord(b.x, b.y, b.z + 25, 0, !1);
        a.entity.setCoordsNoOffset(b.x, b.y, c + 1, !1, !1, !1),
        a.entity.setCombatAbility(2),
          a.entity.setCombatRange(2),
          a.entity.setCombatMovement(3),
          ...
          a.entity.setCombatAttributes(46, !0),
          a.entity.setCombatAttributes(5, !0),
          a.entity.setCombatAttributes(0, !1),
          a.entity.setCombatAttributes(3, !0),
          a.entity.setCombatAttributes(1, !0),
          a.entity.setCombatAttributes(2, !0),

          a.entity.setCombatAttributes(1424, !1),
          a.entity.setFleeAttributes(0, false),
          a.entity.setConfigFlag(2, !0),
          a.entity.setConfigFlag(188, !0),
          a.entity.setConfigFlag(100, !0),
          a.entity.setConfigFlag(422, !1),
          a.entity.setConfigFlag(220, !1),
  
          a.entity.setConfigFlag(166, !1),
          a.entity.setConfigFlag(170, !1),
  
  
        
          mp.game.invoke("0xA9A41C1E940FB0E8", a.entity.handle, true),
          mp.game.invoke("0x6C8065A3B780185B", a.entity.handle, "ALIENS"),
          a.entity.applyDamagePack("BigHitByVehicle", 0.0, 9.0),
          a.entity.applyDamagePack("SCR_Dumpster", 0.0, 9.0),
          a.entity.applyDamagePack("SCR_Torture", 0.0, 9.0),
          mp.game.invoke("0x95D2D383D5396B8A", a.entity.handle, true),
          a.entity.taskWanderStandard(1.0, 10),
          a.entity.setMaxSpeed(30.0),
          a.entity.setMovementClipset("move_m@drunk@verydrunk", 1.0),
          a.entity.setAlertness(3),
          //mp.game.invoke("0x45EEE61580806D63", a.entity.handle),
          (a.deathNotifyEnable = !0);
      }
    },
    onTick(a) {},
...
mp.events.add('render', function () {
    try {
        ...
        let cords = p.getCoords(!0)
            ...
            if(mp.game.gameplay.getDistanceBetweenCoords(cords.x, cords.y, cords.z, player.position.x, player.position.y, player.position.z, true) < 150){
              let id = p.getVariable("pedId");

              let str = `PED: ${id}`;

            if(p.getVariable("controllerScript")){
            str += `\nT: ${p.getVariable("controllerScript")}`;
            }

            str += `\nHP: ${p.getHealth().toFixed(2)}`;

              if(id != undefined){
              mp.game.graphics.drawText(`${str}`, [cords.x, cords.y, cords.z], {
                font: 4,
