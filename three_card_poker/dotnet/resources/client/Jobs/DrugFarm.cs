                ...
                NAPI.Task.Run(() => {
                    try
                    {
                        if (player != null && Main.Players.ContainsKey(player))
                        {
                            ...
                            else if (tryAdd == -2) Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Ваш инвентарь не может вместить больше {nInventory.maxPlayerWeight} кг", 3000);
