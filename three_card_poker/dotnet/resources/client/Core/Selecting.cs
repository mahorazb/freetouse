...
namespace NeptuneEvo.Core
{
    class Selecting : Script
    {
        ...
        public static void playerOfferChangeItems(Player player)
        {
            ...
            player.SetData("TRADE_WITH", offerMaker);
            offerMaker.SetData("TRADE_WITH", player);

            player.SetData("TRADE_MONEY", 0);
            offerMaker.SetData("TRADE_MONEY", 0);

            player.SetData("TRADE_ITEMS", new List<nItem>() { new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), });
            offerMaker.SetData("TRADE_ITEMS", new List<nItem>() { new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), });

            player.SetData("TRADE_READY", false);
            offerMaker.SetData("TRADE_READY", false);

            player.SetData("TRADE_DO", false);
            offerMaker.SetData("TRADE_DO", false);

            List<nItem> items = new List<nItem>() { new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1), new nItem(ItemType.Debug, 1) };

            Trade.OpenTrade(player, items, offerMaker.Name, 5);
            Trade.OpenTrade(offerMaker, items, player.Name, 5);
