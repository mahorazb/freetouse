...
var slots = new Vue({
	...
	methods: {
		deleteChar: () => {
			U.trigger('delChar', slots.currSlotId, slots.nameForDelete, slots.surnameForDelete, slots.passwordForDelete);
		}
	}
})
...
function delchar(data) {
	...
	slots.nameForDelete = '';
	slots.surnameForDelete = '';
	slots.passwordForDelete = '';
}
...
$(document).ready(() => {
	...
	$(document)
		...
		.on('click', '.choose-chars .buy-the', () => {
			U.trigger('buyNewSlot', slots.currSlotId);
			return false;
		})
