...
function enableChatInput(enable) {
    ...
    if (enable != (chat.input != null)) {
        ...
        if (enable) {
            ...
            chat.input = chatvar.append(`
              <div>
\t\t\t\t<div class="chat-btns">
\t\t\t\t\t<button onclick="doInChat(writeDo)" class="chat_btn">/do</button>
\t\t\t\t\t<button onclick="doInChat(writeMe)" class="chat_btn">/me</button>
\t\t\t\t\t<button onclick="doInChat(writeTry)" class="chat_btn">/try</button>
\t\t\t\t\t<button onclick="doInChat(writeB)" class="chat_btn">/b</button>
\t\t\t\t</div>
\t\t\t\t\t<input value="" id="chat_msg" placeholder="Ваше сообщение" type="text" />
\t\t\t</div>
            `).children(":last");
...
$(document).ready(function () {
    ...
    $('.chat-btns').on('click', '.chat_btn', function (e) {
        $('.chat_btn').each(function (index, item) {
