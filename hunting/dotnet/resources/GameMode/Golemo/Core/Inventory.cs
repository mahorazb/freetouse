...
namespace Golemo.Core
{
    class nInventory : Script
    {
        ...
        public static Dictionary<ItemType, uint> ItemModels = new Dictionary<ItemType, uint>()
        {
            ...
            { ItemType.SkinBoar,NAPI.Util.GetHashKey("prop_huf_rag_01") },
            { ItemType.SkinCoyote,NAPI.Util.GetHashKey("prop_huf_rag_01") },
            { ItemType.SkinDeer,NAPI.Util.GetHashKey("prop_huf_rag_01") },
            { ItemType.SkinLion,NAPI.Util.GetHashKey("prop_huf_rag_01") },
            { ItemType.SkinPanther,NAPI.Util.GetHashKey("prop_huf_rag_01") },
            { ItemType.SkinRabbit,NAPI.Util.GetHashKey("prop_huf_rag_01") },
        ...
        public static Dictionary<ItemType, Vector3> ItemsPosOffset = new Dictionary<ItemType, Vector3>()
        {
            ...
            { ItemType.SkinBoar,new Vector3(0, 0, -0.99)},
            { ItemType.SkinCoyote,new Vector3(0, 0, -0.99) },
            { ItemType.SkinDeer,new Vector3(0, 0, -0.99) },
            { ItemType.SkinLion,new Vector3(0, 0, -0.99) },
            { ItemType.SkinPanther,new Vector3(0, 0, -0.99) },
            { ItemType.SkinRabbit,new Vector3(0, 0, -0.99) },
        };
        public static Dictionary<ItemType, Vector3> ItemsRotOffset = new Dictionary<ItemType, Vector3>()
        {
            ...
            { ItemType.SkinBoar,new Vector3(0, 0, 0)},
            { ItemType.SkinCoyote,new Vector3(0, 0, 0) },
            { ItemType.SkinDeer,new Vector3(0, 0, 0) },
            { ItemType.SkinLion,new Vector3(0, 0, 0) },
            { ItemType.SkinPanther,new Vector3(0, 0, 0) },
            { ItemType.SkinRabbit,new Vector3(0, 0, 0) },
        };
        ...
        public static Dictionary<ItemType, int> ItemsStacks = new Dictionary<ItemType, int>()
        {
            ...
            { ItemType.SkinBoar, 1},
            { ItemType.SkinCoyote,1 },
            { ItemType.SkinDeer,1 },
            { ItemType.SkinLion,1 },
            { ItemType.SkinPanther,1 },
            { ItemType.SkinRabbit,1 },
        };
        ...
        public static List<nItem> FindAll(int UUID, ItemType type)
        {
            return Items[UUID].FindAll(i => i.Type == type);
        }
        ...
        public static void onUse(Player player, nItem item, int index)
        {
            try
            {
                ...
                switch (item.Type)
                {
                    ...
                    case ItemType.Hay:
                    case ItemType.Seed:
                    case ItemType.SkinBoar:
                    case ItemType.SkinCoyote:
                    case ItemType.SkinDeer:
                    case ItemType.SkinLion:
                    case ItemType.SkinPanther:
                    case ItemType.SkinRabbit:
                        return;
